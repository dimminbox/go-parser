...
type GameWomenToday struct {
	...
	Player1     int       `gorm:"column:player1" json:"player1"`
	Player1Name string       `gorm:"column:player1Name" json:"player1Name"`
	Player2Name string       `gorm:"column:player2Name" json:"player2Name"`
